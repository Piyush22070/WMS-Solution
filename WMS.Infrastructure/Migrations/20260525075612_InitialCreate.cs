        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalHours = table.Column<double>(type: "float", nullable: true, computedColumnSql: "DATEDIFF(MINUTE, CheckIn, CheckOut) / 60.0", stored: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 5, 25, 7, 56, 12, 581, DateTimeKind.Utc).AddTicks(6820), "HR", "Human Resources" },
                    { 2, new DateTime(2026, 5, 25, 7, 56, 12, 581, DateTimeKind.Utc).AddTicks(6820), "Engineering", "Software Engineering" },
                    { 3, new DateTime(2026, 5, 25, 7, 56, 12, 581, DateTimeKind.Utc).AddTicks(6820), "Finance", "Finance & Accounts" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, null, "$2a$11$mYY/ajl.Xk19S4iKxUqoCuXTx1PGpIj2eG42IlPSvU8OZhb.aPI4a", 1, "admin" });
